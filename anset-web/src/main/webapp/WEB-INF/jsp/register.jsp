    ...
    <section class="content">
      ...
      <div class="col-lg-12">
        <span style="text-align: center; display: block;">
          <img alt="" class="center-block" src="images/ASAL_Logo1.png">
        </span>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12 center-block">
        <p class="center-block" style="text-align: center; font-size: 20px; font-weight: bold;">Create Account</p>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12 center-block">
        <form class="modal-content animate"  name='f' action="process_register" method='POST' class="center-block">
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <div style="width:100%; text-align:center;">
                  <button name="submit" type="submit" value="submit" class="btn btn-primary" style="width:200px; ">Submit</button>
                </div>

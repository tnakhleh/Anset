      ...
      <div class="container-fluid">
            ...
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  10,000 <small>Records (Posts,..)</small>
                </span>
              </div>
              <!-- /.info-box-content -->
            </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">2,000 <small>Persons</small></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="row">
          ...
          <section class="col-lg-7 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="position-relative mb-4">
                  <canvas id="barr1-chart" height="200"></canvas>
                </div>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Most Popular Posts / Comments</h3>
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="javascript:void(0)" class="product-title">Post Text Short
                        <span class="badge badge-warning float-right">1800 Interactions</span></a>
                  ...
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="javascript:void(0)" class="product-title">Post Text Short
                        <span class="badge badge-info float-right">700 Interactions</span></a>
                      <span class="product-description">
                        Post Text
                      </span>
                    </div>
                  ...
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="javascript:void(0)" class="product-title">Post Text Short
                        <span class="badge badge-success float-right">399 Interactions</span></a>
                      <span class="product-description">
                        Post Text
                      </span>
                    </div>
              ...
              <div class="card-footer text-center">
                <a href="javascript:void(0)" class="uppercase">View All List</a>
              </div>
              <!-- /.card-footer -->
            </div>
          ...
          <section class="col-lg-5 connectedSortable">
            ...
            <div class="card">
              <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                  <h3 class="card-title">Words Cloud</h3>
                  <a href="javascript:void(0);">More</a>
                </div>
              </div>
              <div class="card-body">
                <img src="dist/img/wc.png" style="width: 100%;"/>
              </div>
            </div>
            
            <div class="card">
              <div class="card-header border-0">
                <h3 class="card-title">Most Popular Sources</h3>
              </div>
